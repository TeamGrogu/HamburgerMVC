    ...
    public class ProductCFG : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product {ID=104, ProductName="Double Big King Burger",CategoryID=1,Description= "4 adet Hamburger eti, 3 katlı özel ekmeği, cheddar peyniri, salatalık turşusu, doğranmış marul ve soğana eşlik eden özel Big King® sosun birleşimi", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/double-big-king.png?v=285", Price=194.99M },
                ...
                new Product {ID=107, ProductName="Whopper Jr. Burger",CategoryID=1,Description= "Hamburger eti, küçük boy susamlı sandviç ekmeği, salatalık turşusu, ketçap, mayonez, doğranmış marul, domates ve soğandan oluşan, Whopper® lezzetinden vazgeçemeyenlere nefis bir seçim.", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/whopper-jr.png?v=285", Price=109.99M },
                new Product {ID=108, ProductName="Spicy Gurme Burger",CategoryID=1,Description= "Özel kaplamasıyla tavuk göğüs fileto, mısır irmiği ile süslemeli özel ekmeği, spicy sosu, domatesi ve doğranmış maruldan oluşan yeni bir lezzet.", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/spicy-gurme-tavuk.png?v=285", Price=109.99M },
                ...
                new Product {ID=306, ProductName="Ayran",CategoryID=3,Description= "Ayran", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/sprite.png?v=285", Price=35.99M },  
                ...
                new Product {ID=312, ProductName="Cappuccino",CategoryID=3,Description= "Karadeniz Lezzeti", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/vanilyali-cappuccino.png?v=285", Price=35.99M },  
                ...
                new Product {ID=404, ProductName="Vişneli Tatlı",CategoryID=4,Description= "Vanilyalı, Çilekli, Çikolatalı, Espressolu, Limonlu çeşitleriyle.", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/espressolu-milkshake.png?v=285", Price=55.99M },  
                new Product {ID=405, ProductName="Vişneli Tatlı",CategoryID=4,Description= "Vanilyalı, Çilekli, Çikolatalı, Espressolu, Limonlu çeşitleriyle.", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/espressolu-milkshake.png?v=285", Price=55.99M },  
                new Product {ID=406, ProductName="King Sundae",CategoryID=4,Description= "Vanilyalı, Çikolata Soslu, Böğürtlen Soslu, Karamel Soslu, Çilek Soslu, Limonlu", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/king-sundae.png?v=285", Price=65.99M },  
                new Product {ID=407, ProductName="Bkool",CategoryID=4,Description= "Çikolata Parçacıklı, Renkli Çikolata Drajeleri, Limonlu", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/bkool.png?v=285", Price=75.99M },  
                ...
                new Product {ID=506, ProductName="Mini Ketçap",CategoryID=5,Description= "Mini Ketçap", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/mini-ketcap.png?v=285", Price=10.99M },  
                ...
                new Product {ID=508, ProductName="Buffalo Sos",CategoryID=5,Description= "Buffalo Sos", ProductImage= "https://www.burgerking.com.tr/cmsfiles/products/mini-buffalo-1.png?v=285", Price=10.99M },  
                new Product {ID=601, ProductName="Marul",CategoryID=6,Description= "Marul",Price=5.99M },  
                new Product {ID=602, ProductName="Domates",CategoryID=6,Description= "Domates",Price=5.99M },  
                new Product {ID=603, ProductName="Cheddar Peyniri",CategoryID=6,Description= "Cheddar Peyniri", Price=5.99M },  
                new Product {ID=604, ProductName="Turşu",CategoryID=6,Description= "Turşu", Price=5.99M },  
                new Product {ID=605, ProductName="Soğan",CategoryID=6,Description= "Soğan", Price=5.99M }
